...
(setq package--builtins '(
  ...
  (cfengine . [nil nil "mode for editing Cfengine files"])
  ...
  (diff . [nil nil "run `diff' in compilation-mode"])
  ...
  (emacs-lock . [nil nil "prevents you from exiting Emacs if a buffer is locked"])
  ...
  (feedmail . [(8) nil "assist other email packages to massage outgoing messages"])
  ...
  (htmlfontify . [(0 21) nil "htmlise a buffer/source tree with optional hyperlinks"])
  ...
  (json . [(1 2) nil "JavaScript Object Notation parser / generator"])
  ...
  (mh-e . [(8 2) nil "GNU Emacs interface to the MH mail system"])
  ...
  (org . [(7 4) nil "Outline-based notes management and organizer"])
  (outline . [nil nil "outline mode commands for Emacs"])
  (package . [(0 9) nil "Simple package system for Emacs"])
  ...
  (quickurl . [nil nil "insert an URL based on text at point in buffer"])
  ...
  (sha1 . [nil nil "SHA1 Secure Hash Algorithm in Emacs-Lisp"])
  ...
  (sql . [(2 8) nil "specialized comint.el for SQL interpreters"])
  ...
  (viper . [(3 14 1) nil "A full-featured Vi emulator for GNU Emacs and XEmacs,"])
  ...
  (whitespace . [(13 2) nil "minor mode to visualize TAB, (HARD) SPACE, NEWLINE"])
