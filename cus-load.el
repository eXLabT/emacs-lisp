...
(put 'gnus-server 'custom-loads '(gnus-srvr gnus nnheader))
...
(put 'org 'custom-loads '(org org-attach ob org-capture org-complete org-crypt org-entities org-exp org-feed org-footnote org-freemind org-id org-indent org-mobile org-mouse org-protocol org-publish org-remember))
...
(put 'comm 'custom-loads '(ange-ftp browse-url dig eudc-vars goto-addr gravatar ldap net-utils netrc proto-stream tls tramp url-vars xesam))
(put 'convenience 'custom-loads '(cus-edit autoinsert autorevert bs completion cua-base dabbrev ffap filecache filesets follow hippie-exp hl-line ibuffer ido imenu iswitchb kmacro linum master org-protocol repeat reveal ruler-mode speedbar vcursor whitespace windmove))
...
(put 'files 'custom-loads '(ange-ftp autoinsert autorevert cus-edit dired filecache latexenc recentf shadowfile tramp uniquify))
...
(put 'org-babel 'custom-loads '(ob-js ob-lisp org ob-lob ob ob-tangle ob-scheme ob-exp ob-plantuml org-src))
...
(defvar custom-versions-load-alist '(("22.3" message) ("21.2" mm-util) ("20.3.3" "dos-vars") ("20.1" time-stamp) ("21.3" sql gnus-agent ange-ftp) ("23.3" diary-lib desktop calendar python rmail rmailsum) ("19.29" time-stamp) ("22" ps-print ebnf2ps) ("22.2" vc-hg sql bibtex-style vc-mtn gnus-sum css-mode desktop tls mail-source find-dired gdb-mi dired) ("20.3" dabbrev ffap vc xscheme sendmail rmail paren uce which-func diary-lib debug msb avoid hexl vcursor browse-url compile etags add-log find-func cus-edit) ("21.1" server debug rmailedit ezimage dabbrev latin1-disp gnus-start hideshow strokes sgml-mode net-utils cperl-mode ange-ftp paren fortran etags cal-hebrew sb-image vc-sccs vc gnus-group gnus-sum smtpmail add-log sendmail find-func wid-edit vc-rcs gnus-art vc-cvs nnmail message ps-print cus-edit gnus-agent flyspell rmail browse-url) ("20.4" crisp sh-script compile hilit-chg) ("23.2" rmailmm ansi-color mm-encode lunar diary-lib help-fns comint dired bytecomp gnus-group calendar message desktop doc-view gnus-sum auth-source gdb-mi rmail tramp-gvfs elint) ("20" ps-print ebnf2ps) ("20.8" sql) ("24.1" em-ls gnus-srvr etags compile shell esh-util em-rebind python comint woman vc-svn proto-stream mml2015 vc-git ibuffer esh-proc gnus-util esh-ext auth-source ido pop3 sendmail em-banner vc-rcs em-alias vc-hg log-edit pcmpl-unix esh-arg mm-decode smiley message em-glob js esh-var gnus-html shr esh-cmd em-prompt mml vc-sccs gnus-msg package em-cmpl em-term gnus-start cus-edit em-unix copyright package-x gnus-art em-hist server em-dirs appt rcirc sql rst gnus-gravatar gnus-group vc-cvs em-smart url-cache mm-view esh-io em-pred browse-url gnus-sum dired-x esh-mode em-script gnus) ("23.1" rmail mm-decode vc-arch icomplete smime gnus-dired spam-report bibtex pop3 informat vc-cvs mm-uu copyright cus-edit descr-text vc-git newcomment dired-aux gnus-bookmark info fortune gnus-score checkdoc server woman sendmail smiley compile view holidays hideif mml gnus-group pcmpl-unix tls rmailmm gnus-draft gnus-util gnus imap nnmail net-utils nnmairix "misearch" gnus-sum browse-url ffap time calendar filesets vc-mtn gnus-msg fortran face-remap f90 tex-mode vc-hg gnus-art message) ("22.1" imenu mm-view cal-tex gnus-srvr gnus-score smiley add-log bookmark shadowfile gnus-int gnus-group view hi-lock gnus-win server tcl descr-text latin1-disp fortran gnus-delay tex-mode sgml-mode sql gnus-util landmark mail-extr sh-script hl-line make-mode mml2015 vc-cvs ielm generic-x imap gnus-start mml-sec comint desktop locate gnus-msg compare-w info uudecode cal-dst gnus-agent spam find-dired diff-mode ange-ftp mml gnus-fun ispell gnus-spec warnings gnus smtpmail sendmail dabbrev pop3 smime time binhex dired rmail allout mm-url gdb-mi vc-svn mm-decode x-dnd mm-util vc mm-uu autorevert mail-source flow-fill diary-lib iswitchb find-func gnus-art gnus-cite tls nnmail glasses deuglify calendar ffap compile starttls cus-edit gnus-sum grep keypad message))
